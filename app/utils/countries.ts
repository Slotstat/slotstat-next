export const countries = [
  ...
  },
  {
    ...
    states: [
      { name: "Alabama", emoji: "🇺🇸", code: "AL" },
      { name: "Alaska", emoji: "🇺🇸", code: "AK" },
      { name: "Arizona", emoji: "🇺🇸", code: "AZ" },
      { name: "Arkansas", emoji: "🇺🇸", code: "AR" },
      { name: "California", emoji: "🇺🇸", code: "CA" },
      { name: "Colorado", emoji: "🇺🇸", code: "CO" },
      { name: "Connecticut", emoji: "🇺🇸", code: "CT" },
      { name: "Delaware", emoji: "🇺🇸", code: "DE" },
      { name: "Florida", emoji: "🇺🇸", code: "FL" },
      { name: "Georgia", emoji: "🇺🇸", code: "GA" },
      { name: "Hawaii", emoji: "🇺🇸", code: "HI" },
      { name: "Idaho", emoji: "🇺🇸", code: "ID" },
      { name: "Illinois", emoji: "🇺🇸", code: "IL" },
      { name: "Indiana", emoji: "🇺🇸", code: "IN" },
      { name: "Iowa", emoji: "🇺🇸", code: "IA" },
      { name: "Kansas", emoji: "🇺🇸", code: "KS" },
      { name: "Kentucky", emoji: "🇺🇸", code: "KY" },
      { name: "Louisiana", emoji: "🇺🇸", code: "LA" },
      { name: "Maine", emoji: "🇺🇸", code: "ME" },
      { name: "Maryland", emoji: "🇺🇸", code: "MD" },
      { name: "Massachusetts", emoji: "🇺🇸", code: "MA" },
      { name: "Michigan", emoji: "🇺🇸", code: "MI" },
      { name: "Minnesota", emoji: "🇺🇸", code: "MN" },
      { name: "Mississippi", emoji: "🇺🇸", code: "MS" },
      { name: "Missouri", emoji: "🇺🇸", code: "MO" },
      { name: "Montana", emoji: "🇺🇸", code: "MT" },
      { name: "Nebraska", emoji: "🇺🇸", code: "NE" },
      { name: "Nevada", emoji: "🇺🇸", code: "NV" },
      { name: "New Hampshire", emoji: "🇺🇸", code: "NH" },
      { name: "New Jersey", emoji: "🇺🇸", code: "NJ" },
      { name: "New Mexico", emoji: "🇺🇸", code: "NM" },
      { name: "New York", emoji: "🇺🇸", code: "NY" },
      { name: "North Carolina", emoji: "🇺🇸", code: "NC" },
      { name: "North Dakota", emoji: "🇺🇸", code: "ND" },
      { name: "Ohio", emoji: "🇺🇸", code: "OH" },
      { name: "Oklahoma", emoji: "🇺🇸", code: "OK" },
      { name: "Oregon", emoji: "🇺🇸", code: "OR" },
      { name: "Pennsylvania", emoji: "🇺🇸", code: "PA" },
      { name: "Rhode Island", emoji: "🇺🇸", code: "RI" },
      { name: "South Carolina", emoji: "🇺🇸", code: "SC" },
      { name: "South Dakota", emoji: "🇺🇸", code: "SD" },
      { name: "Tennessee", emoji: "🇺🇸", code: "TN" },
      { name: "Texas", emoji: "🇺🇸", code: "TX" },
      { name: "Utah", emoji: "🇺🇸", code: "UT" },
      { name: "Vermont", emoji: "🇺🇸", code: "VT" },
      { name: "Virginia", emoji: "🇺🇸", code: "VA" },
      { name: "Washington", emoji: "🇺🇸", code: "WA" },
      { name: "West Virginia", emoji: "🇺🇸", code: "WV" },
      { name: "Wisconsin", emoji: "🇺🇸", code: "WI" },
      { name: "Wyoming", emoji: "🇺🇸", code: "WY" },
    ],
  },
  {
    name: "Uruguay",
