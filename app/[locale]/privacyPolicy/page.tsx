  ...
  return (
    <>
      ...
      <div className="text-grey1 mb-10">
        ...
        <p>
          At SlotStat, we’re strongly committed to protecting and respecting
          your privacy.
        </p>
        <p className="mb-5">
        ...
        <p className="mb-5">
          This Privacy Policy explains when and why and how we collect and use
        ...
        <p className="mb-5">
          ...
          with us via email; (b) aggregate information concerning what pages
          users access or visit or how do they act using service; (c)
          information given by the user (such as survey information and/or site
          registrations); and (d) information related to your use of the Website
          and/or the mobile application, including IP address, Device ID,
          geographic location, and date and time of your request; (e) any other
          information that you might provide voluntarily. We might also collect
        ...
        <ol>
          <li className="mb-3">
            1. To fulfill a contract or take steps linked to a contract such as
          ...
          <li className="mb-3 ml-1">
            2. Where it is necessary for purposes which are in SlotStat’s
            legitimate interests such as (a) to provide the information or
            content you have requested; (b) to contact you about our programs,
            products, features or services; (c) to improve our services and for
            internal business purposes such as identification and authentication
            or customer service, portfolio tracking and user preference syncing
            ...
            products, features or services, you can opt-out of marketing
            communications. Where you give us consent, such as (a) where you ask
            us to send marketing information to you via a medium where we need
            your consent, including alerts via mobile push notifications; (b)
          ...
          <li className="mb-3 ml-1">
            3. Where we are legally required to do so. We may also provide
            access to your personally identifiable information when legally
            required to do so, to cooperate with police investigations or other
            legal proceedings, to protect against misuse or unauthorized use of
            our Website, to limit our legal liability and protect our rights, or
            to protect the rights, property or safety of visitors of the Website
            or the public. In those instances, the information is provided only
            for that purpose.
          </li>
        </ol>
        ...
        <ol>
          <li className="mb-3 ml-1">
            1. It is necessary to share information in order to investigate,
          ...
          <li className="mb-3 ml-1">
            2. We provide personal information to trusted businesses or persons
            for the sole purpose of processing personally identifying
            information on our behalf and provide us with services. When this is
            done, it is subject to agreements that oblige those parties to
            process such information only on our instructions and in compliance
            with this Privacy Policy and appropriate confidentiality and
            security measures.
          </li>
          <li className="mb-3 ml-1">
            3. We provide such information to third parties who have entered
            into non-disclosure agreements with us.
          </li>
          <li className="mb-3 ml-1">
            4. We provide such information to a company controlled by, or under
            common control with,Gembling Herald Limited LLC for any purpose
            permitted by this Privacy Policy.
          </li>

          <li className="mb-3 ml-1">
            5. We may aggregate, anonymize, and publish data for statistical and
        ...
        <p>
          ...
          measures, including but not limited to firewalls. We strongly advise
          you to change your password frequently and not to use the same
          password for different websites. We cannot protect, nor does this
          Privacy Policy apply to, any information that you transmit to other
        ...
        <p>
          ...
          as well as the right to restrict and object to certain processing of
          your information. While some of these rights apply generally, certain
          rights apply only in certain limited circumstances. We briefly
        ...
        <p>
          ...
          have the right to the portability of your data. You can also ask us
          not to send marketing communications and not to use your personal data
        ...
        <p>
          ...
          Each category of data may be used by Gambling Herald Limited LLC or
          shared with third parties also as described in this Privacy Policy.
          Residents of California have the right to request access to and
