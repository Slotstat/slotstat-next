  ...
  return (
    <>
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        >
          {chosen ? (
            <div className="font-bold text-base flex flex-row items-center text-white">
        ...
        {errorState && (
          <p className="text-red -mt-5 ml-2 mb-2 text-xs font-normal ">
            select state
          </p>
        )}
          ...
          <div className="z-50 top-full left-0 w-full max-h-72 mt-1 absolute bg-grey3 rounded-lg p-1.5 ">
            <div className="relative flex items-center bg-dark2 m-1.5 rounded-lg">
              <input
                ...
                text-xs text-grey1 lg:text-sm focus:border-dark2 focus:outline-none rounded-r-lg rounded-lg"
              />
